  ...
  stimulus: `
     <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh;">
      <div style="margin-bottom: 40px; text-align: center; max-width: 800px;">
        ...
        <p>이 화면을 넘어가면 작은 상자들이 좌우로 와리가리를 치고는 사라집니다.</p>
        <p>와리가리 중에 원기둥이 회전하는 듯한 느낌이 드셨다면,</p>
        <p>시계방향과 반시계방향 중 어느 쪽이었는지 버튼을 클릭해주세요.(하단 이미지 참고)</p>
        <p>'아닌데 회전 안하든데' ← 걍 나가시면 됩니다</p>
        <p>참가해주시겠다면 아무 키나 눌러서 실험을 진행해주세요.</p>
      </div>
