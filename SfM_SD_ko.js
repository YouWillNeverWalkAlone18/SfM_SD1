  ...
  return `
    <div style="max-width: 800px; margin: 0 auto; font-size: 16px; line-height: 1.6; text-align: left; color: #e0e0e0;">
      ...
      <p>
        ...
        본 연구에 관한 문의사항은
        <a href="cp0175ii@ed.ritsumei.ac.jp">cp0175ii@ed.ritsumei.ac.jp</a> 로 보내주시면 됩니다。
      </p>
      ...
      <div style="border: 1px solid #aaa; padding: 10px; height: 250px; overflow-y: auto; margin-bottom: 20px; text-align: left;">
        ...
        실험에서는、지시에 따라 화면 상에 제시되는 시각 자극에 대한 관찰과 응답이 요구됩니다.</p>
        소요시간은 10분 전후로 예상됩니다.<br>
        (천천히 하시면 그만큼 늦어집니다.)<br>
        화면 상에 이미지나 움직임이 반복제시되며, 제시되는 대부분의 자극은 정확한 판단이 어려운, 애매한 자극입니다.</p> 

        <p><strong>위험성 / 불쾌감에 관한 설명</strong><br>
        피로를 제외하면, 치명적인 신체적 위험성이나 불쾌감은 없습니다.<br>
        단, 본 실험에서는 3D 회전 착시가 일어나는 자극이 사용됩니다.<br>
        따라서、반복 회전하는 물체에 거부감을 느끼시거나, 현기증 혹은 멀미가 걱정되시는 경우,<br>
        또한 실험 중에 상태가 나빠졌다 느끼신 경우, 언제든지 실험을 중단해주시면 됩니다.</p>

        <p><strong>조사 내용에 관한 설명</strong><br>
        본 실험에서는, 화면 상에 텍스트와 이미지, 이미지의 동작이 제시됩니다.<br>
        ...
        또한 참가자 본인의 요청이 있다면, 즉시 데이터를 폐기합니다. 단, 해당 데이터를 통한 논문이 게재되었을 경우 폐기 불가합니다.<br>
